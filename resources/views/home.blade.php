        ...
        @foreach ($post as $p)
            <div class="col-sm-4">
                <div class="card tiap spasi">
                    <img class="gambar_post center"  style=" height:300px" src="{{ Storage::url($p->file_gambar) }}" alt="gambar {{ $p->judul }}">
                    <div class="card-body text">
                        ...
                        <h6 class="card-subtitle mb-2 text-muted"><span class="blog-date">Tanggal Post : {{ $p->tgl_insert }}</span></h6>
